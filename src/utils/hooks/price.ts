...
export const useTotalPrice = ({ pricePerHour }: TotalPriceType) => {
  ...
  useEffect(() => {
    console.log('useTotalPrice effect: startTime', startTime)
    console.log('useTotalPrice effect: endTime', endTime)
    console.log('useTotalPrice effect: pricePerHour', pricePerHour)
    ...
    console.log('useTotalPrice effect: parkingCharge', parkingCharge)

    setParkingCharge(parkingCharge)
  }, [pricePerHour, startTime, endTime])

  useEffect(() => {
    console.log('useTotalPrice effect: valet', valet)
    ...
    console.log('useTotalPrice effect: pickupCharge', pickupCharge)
    console.log('useTotalPrice effect: dropoffCharge', dropoffCharge)
